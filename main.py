...
label_result = Label(root, height=2, text="", font=("arial", 30))
label_result.pack()
...
Button(root, text="=", width=5, height=3, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#fe3037", command=lambda: calculate()).place(x=430, y=400)
